...
import com.ray.dingtalk.qy.model.message.notice.FileMessage;
import com.ray.dingtalk.qy.model.message.notice.ImageMessage;
import com.ray.dingtalk.qy.model.message.notice.Link;
import com.ray.dingtalk.qy.model.message.notice.LinkMessage;
import com.ray.dingtalk.qy.model.message.notice.Markdown;
import com.ray.dingtalk.qy.model.message.notice.MarkdownMessage;
import com.ray.dingtalk.qy.model.message.notice.Media;
import com.ray.dingtalk.qy.model.message.notice.Message;
import com.ray.dingtalk.qy.model.message.notice.Text;
import com.ray.dingtalk.qy.model.message.notice.TextMessage;
import com.ray.dingtalk.qy.model.message.notice.Voice;
import com.ray.dingtalk.qy.model.message.notice.VoiceMessage;
import com.ray.dingtalk.qy.util.HttpHelper;

/**@desc  :  企业通知消息接口（即将废弃）
 * 
 * 参考文档：https://g.alicdn.com/dingding/opendoc/docs/_server/tab8.html
 * 
 * @author: shirayner
